...
describe("Delete All Responses (2.0)", () => {
    ...
    it("Delete All Responses", () => {
        commandTest(
            "tests/fixtures/delete-all-responses/2.0/delete-all-responses.before.json",
            "tests/fixtures/delete-all-responses/2.0/delete-all-responses.after.json",
...
describe("Delete All Responses (3.0)", () => {
    ...
    it("Delete All Responses", () => {
        commandTest(
            "tests/fixtures/delete-all-responses/3.0/delete-all-responses.before.json",
            "tests/fixtures/delete-all-responses/3.0/delete-all-responses.after.json",
