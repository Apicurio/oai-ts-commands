...
describe("Delete Contact (2.0)", () => {
    ...
    it("Delete Contact", () => {
        commandTest(
            "tests/fixtures/delete-contact/2.0/delete-contact.before.json",
            "tests/fixtures/delete-contact/2.0/delete-contact.after.json",
...
describe("Delete Contact (3.0)", () => {
    ...
    it("Delete Contact", () => {
        commandTest(
            "tests/fixtures/delete-contact/3.0/delete-contact.before.json",
            "tests/fixtures/delete-contact/3.0/delete-contact.after.json",
