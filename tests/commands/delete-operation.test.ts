...
describe("Delete Operation (2.0)", () => {
    ...
    it("Delete Operation", () => {
        commandTest(
            "tests/_fixtures/commands/delete-operation/2.0/delete-operation.before.json",
            "tests/_fixtures/commands/delete-operation/2.0/delete-operation.after.json",
...
describe("Delete Operation (3.0)", () => {
    ...
    it("Delete Operation", () => {
        commandTest(
            "tests/_fixtures/commands/delete-operation/3.0/delete-operation.before.json",
            "tests/_fixtures/commands/delete-operation/3.0/delete-operation.after.json",
