...
describe("Change Property Type (2.0)", () => {
    ...
    it("Change Property Type", () => {
        commandTest(
            "tests/_fixtures/commands/change-property-type/2.0/change-property-type.before.json",
            "tests/_fixtures/commands/change-property-type/2.0/change-property-type.after.json",
    ...
    it("Change Property Type (Required)", () => {
        commandTest(
            "tests/_fixtures/commands/change-property-type/2.0/change-property-type-required.before.json",
            "tests/_fixtures/commands/change-property-type/2.0/change-property-type-required.after.json",
            (document: Oas20Document) => {
...
describe("Change Property Type (3.0)", () => {
    ...
    it("Change Property Type", () => {
        commandTest(
            "tests/_fixtures/commands/change-property-type/3.0/change-property-type.before.json",
            "tests/_fixtures/commands/change-property-type/3.0/change-property-type.after.json",
    ...
    it("Change Property Type (Required)", () => {
        commandTest(
            "tests/_fixtures/commands/change-property-type/3.0/change-property-type-required.before.json",
            "tests/_fixtures/commands/change-property-type/3.0/change-property-type-required.after.json",
            (document: Oas30Document) => {
                let property: Oas30PropertySchema = document.components.getSchemaDefinition("MySchema1").property("name") as Oas30PropertySchema;
                let type: SimplifiedPropertyType = new SimplifiedPropertyType();
                type.type = "string";
