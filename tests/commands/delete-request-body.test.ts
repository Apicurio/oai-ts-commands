...
describe("Delete Request Body (3.0)", () => {
    ...
    it("Delete Request Body", () => {
        commandTest(
            "tests/_fixtures/commands/delete-request-body/3.0/delete-request-body.before.json",
            "tests/_fixtures/commands/delete-request-body/3.0/delete-request-body.after.json",
