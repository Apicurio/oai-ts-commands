...
describe("Delete Parameter (2.0)", () => {
    ...
    it("Delete Parameter", () => {
        commandTest(
            "tests/_fixtures/commands/delete-parameter/2.0/delete-parameter.before.json",
            "tests/_fixtures/commands/delete-parameter/2.0/delete-parameter.after.json",
...
describe("Delete Parameter (3.0)", () => {
    ...
    it("Delete Parameter", () => {
        commandTest(
            "tests/_fixtures/commands/delete-parameter/3.0/delete-parameter.before.json",
            "tests/_fixtures/commands/delete-parameter/3.0/delete-parameter.after.json",
