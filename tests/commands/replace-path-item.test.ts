...
describe("Replace Path Item (2.0)", () => {
    ...
    it("Replace Path Item", () => {
        commandTest(
            "tests/_fixtures/commands/replace-path-item/2.0/replace-path-item.before.json",
            "tests/_fixtures/commands/replace-path-item/2.0/replace-path-item.after.json",
...
describe("Replace Path Item (3.0)", () => {
    ...
    it("Replace Path Item", () => {
        commandTest(
            "tests/_fixtures/commands/replace-path-item/3.0/replace-path-item.before.json",
            "tests/_fixtures/commands/replace-path-item/3.0/replace-path-item.after.json",
