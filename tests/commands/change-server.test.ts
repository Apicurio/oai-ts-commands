...
describe("Change Server (3.0)", () => {
    ...
    it("Change Server (Document)", () => {
        commandTest(
            "tests/_fixtures/commands/change-server/3.0/change-server-document.before.json",
            "tests/_fixtures/commands/change-server/3.0/change-server-document.after.json",
    ...
    it("Change Server (Path Item)", () => {
        commandTest(
            "tests/_fixtures/commands/change-server/3.0/change-server-pathItem.before.json",
            "tests/_fixtures/commands/change-server/3.0/change-server-pathItem.after.json",
            (document: Oas30Document) => {
    ...
    it("Change Server (Operation)", () => {
        commandTest(
            "tests/_fixtures/commands/change-server/3.0/change-server-operation.before.json",
            "tests/_fixtures/commands/change-server/3.0/change-server-operation.after.json",
            (document: Oas30Document) => {
