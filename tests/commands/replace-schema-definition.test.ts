...
describe("Replace Schema Definition (2.0)", () => {
    ...
    it("Replace Schema Definition", () => {
        commandTest(
            "tests/_fixtures/commands/replace-schema-definition/2.0/replace-schema-definition.before.json",
            "tests/_fixtures/commands/replace-schema-definition/2.0/replace-schema-definition.after.json",
...
describe("Replace Schema Definition (3.0)", () => {
    ...
    it("Replace Schema Definition", () => {
        commandTest(
            "tests/_fixtures/commands/replace-schema-definition/3.0/replace-schema-definition.before.json",
            "tests/_fixtures/commands/replace-schema-definition/3.0/replace-schema-definition.after.json",
