...
describe("New Security Scheme (2.0)", () => {
    ...
    it("New Security Scheme", () => {
        commandTest(
            "tests/_fixtures/commands/new-security-scheme/2.0/new-security-scheme.before.json",
            "tests/_fixtures/commands/new-security-scheme/2.0/new-security-scheme.after.json",
...
describe("New Security Scheme (3.0)", () => {
    ...
    it("New Security Scheme", () => {
        commandTest(
            "tests/_fixtures/commands/new-security-scheme/3.0/new-security-scheme.before.json",
            "tests/_fixtures/commands/new-security-scheme/3.0/new-security-scheme.after.json",
