...
describe("Delete Media Type (3.0)", () => {
    ...
    it("Delete Media Type (Request Body)", () => {
        commandTest(
            "tests/_fixtures/commands/delete-media-type/3.0/delete-media-type-requestBody.before.json",
            "tests/_fixtures/commands/delete-media-type/3.0/delete-media-type-requestBody.after.json",
    ...
    it("Delete Media Type (Response)", () => {
        commandTest(
            "tests/_fixtures/commands/delete-media-type/3.0/delete-media-type-response.before.json",
            "tests/_fixtures/commands/delete-media-type/3.0/delete-media-type-response.after.json",
            (document: Oas30Document) => {
                let operation: Oas30Operation = document.paths.pathItem("/foo").get as Oas30Operation;
