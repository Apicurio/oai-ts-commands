...
describe("New Media Type (3.0)", () => {
    ...
    it("New Media Type (Parameter)", () => {
        commandTest(
            "tests/fixtures/new-media-type/3.0/new-media-type-parameter.before.json",
            "tests/fixtures/new-media-type/3.0/new-media-type-parameter.after.json",
    ...
    it("New Media Type (Request Body)", () => {
        commandTest(
            "tests/fixtures/new-media-type/3.0/new-media-type-requestBody.before.json",
            "tests/fixtures/new-media-type/3.0/new-media-type-requestBody.after.json",
            (document: Oas30Document) => {
    ...
    it("New Media Type (Response)", () => {
        commandTest(
            "tests/fixtures/new-media-type/3.0/new-media-type-response.before.json",
            "tests/fixtures/new-media-type/3.0/new-media-type-response.after.json",
            (document: Oas30Document) => {
