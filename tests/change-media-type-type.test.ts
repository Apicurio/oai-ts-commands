...
describe("Change Media Type (3.0)", () => {
    ...
    it("Change Media Type (Response)", () => {
        commandTest(
            "tests/fixtures/change-media-type-type/3.0/change-media-type-type-response.before.json",
            "tests/fixtures/change-media-type-type/3.0/change-media-type-type-response.after.json",
