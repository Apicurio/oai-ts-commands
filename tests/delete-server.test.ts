...
describe("Delete Server (3.0)", () => {
    ...
    it("Delete Server (Document)", () => {
        commandTest(
            "tests/fixtures/delete-server/3.0/delete-server-document.before.json",
            "tests/fixtures/delete-server/3.0/delete-server-document.after.json",
    ...
    it("Delete Server (Path Item)", () => {
        commandTest(
            "tests/fixtures/delete-server/3.0/delete-server-pathItem.before.json",
            "tests/fixtures/delete-server/3.0/delete-server-pathItem.after.json",
            (document: Oas30Document) => {
    ...
    it("Delete Server (Operation)", () => {
        commandTest(
            "tests/fixtures/delete-server/3.0/delete-server-operation.before.json",
            "tests/fixtures/delete-server/3.0/delete-server-operation.after.json",
            (document: Oas30Document) => {
